...
export const usuarioAutenticado = () => localStorage.getItem('2rpsystem-token-autenticacao') !== null;
...
export const parseJwt = () => {
    ...
    let base64 = localStorage.getItem('2rpsystem-token-autenticacao').split('.')[1];
